...
const translations: Record<Language, TranslationKeys> = {
  uz: {
    ...
    // Rating system
    rateYourExperience: 'Tajribangizni baholang',
    rateOrderDescription: 'Bu buyurtma bilan tajribangiz qanday edi?',
    orderSummary: 'Buyurtma xulosasi',
    from: 'dan',
    rateSeller: 'Sotuvchini baholang',
    ...
    commentPlaceholder: 'Bu sotuvchi bilan tajribangizni baham ko\'ring...',
    pleaseSelectRating: 'Iltimos, baholashni tanlang',
    ratingSubmissionFailed: 'Baholash yuborishda xatolik. Qayta urinib ko\'ring.',
    ratingSubmitted: 'Baholash yuborildi!',
    thankYouForRating: 'Tajribangizni baholaganingiz uchun rahmat. Fikringiz bizga xizmatni yaxshilashga yordam beradi.',
    backToOrders: 'Buyurtmalarga qaytish',
    submitRating: 'Baholashni yuborish',
    submitting: 'Yuborilmoqda...',
    orderConfirmedRatePrompt: 'Buyurtmangiz tasdiqlandi! Tajribangizni baholashni xohlaysizmi?',
  ...
  ru: {
    ...
    rateOrderDescription: 'Как прошла ваша покупка?',
    orderSummary: 'Сводка заказа',
    from: 'от',
    rateSeller: 'Оцените продавца',
    ...
    commentPlaceholder: 'Поделитесь своим опытом с этим продавцом...',
    pleaseSelectRating: 'Пожалуйста, выберите оценку',
    ratingSubmissionFailed: 'Не удалось отправить оценку. Попробуйте еще раз.',
    ratingSubmitted: 'Оценка отправлена!',
    thankYouForRating: 'Спасибо за вашу оценку. Ваш отзыв помогает нам улучшить сервис.',
    backToOrders: 'Назад к заказам',
    submitRating: 'Отправить оценку',
    submitting: 'Отправка...',
    orderConfirmedRatePrompt: 'Ваш заказ подтвержден! Хотите оценить ваш опыт?',
